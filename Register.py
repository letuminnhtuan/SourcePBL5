...
class regis:
    def __init__(self, license_plate, root):
        ...
        self.quantity_entry = ctk.CTkEntry(self.root, placeholder_text="Số lượng", corner_radius=10, border_color="#FF9999",
                                      width=220)
        ...
        save = ctk.CTkButton(master=self.root,text="Hoàn tất",font=("Helvetica", 15),command=self.save_data,text_color="white",hover=True,hover_color="#ffb557",
